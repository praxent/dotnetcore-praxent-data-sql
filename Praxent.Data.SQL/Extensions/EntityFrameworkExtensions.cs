...
namespace Praxent.Data.SQL.Extensions
{
    // https://stackoverflow.com/a/49597502
    public static class EntityFrameworkExtensions
    {
        public static IQueryable<T> IncludePropertyPaths<T>(this IQueryable<T> source, IEnumerable<string> navigationPropertyPaths)
            where T : class
        {
